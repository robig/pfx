 ...
 *
 * Title: Full Featured PHP Browser/OS detection
 * @copyright 2008-2010 Harald Hope
 *
 * @package PFX
		...
		*/
		...
		$a_browser_types        = array(
			...
			array(
				...
				'w3m',
				'bbro'
			), // open source browser, more features than lynx/links
			array(
				'webtv',
				false,
				'webtv',
			...
			array(
				...
				'dillo',
				'bbro'
			), // linux browser, basic table support
			array(
				'ibrowse',
				false,
				'ibrowse',
			...
			array(
				...
				'yahoomm',
				'bot'
			), // gets Yahoo-MMCrawler and Yahoo-MMAudVid bots
			array(
				'inktomi',
				false,
				'inktomi',
			...
			array(
				...
				'ibm',
				'bot'
			), // ibm almaden web crawler
			array(
				'baiduspider',
				false,
				'baidu',
				'bot'
			), // Baiduspider asian search spider
			array(
				'psbot',
				false,
				'psbot',
			...
			array(
				...
				'naverbot',
				'bot'
			), // naverbot crawler, bad bot, block
			array(
				'surveybot',
				false,
				'surveybot',
			...
			array(
				...
				'answerbus',
				'bot'
			), // http://www.answerbus.com/, web questions
			array(
				'sohu-search',
				false,
				'sohu',
				'bot'
			), // chinese media company, search component
			array(
			...
			array(
				...
				'wget',
				'dow'
			), // open source downloader, obeys robots.txt
